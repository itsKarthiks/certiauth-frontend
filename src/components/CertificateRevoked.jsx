...
const CertificateRevoked = ({ certData, onBack }) => {
    ...
    return (
        <div className="min-h-screen w-full flex flex-col items-center justify-center bg-[#0a0a0a] p-4">
            <div className="bg-[#0a0a0a] w-full max-w-lg mx-auto border-t-4 border-yellow-500 rounded-b-sm shadow-2xl pb-8 relative overflow-hidden">

                {/* Subtle top gradient glow */}
                <div className="absolute top-0 left-0 w-full h-24 bg-gradient-to-b from-yellow-900/20 to-transparent pointer-events-none"></div>
                ...
                <div className="px-10 pt-12 pb-6 flex flex-col items-center relative z-10">
                    ...
                    <div className="w-full border border-dashed border-[#ffffff15] rounded-sm p-6 mb-10 bg-black">
                        ...
                        <div className="flex justify-between items-start mb-6">
                            <div>
                                ...
                                <p className="text-sm font-mono text-yellow-500 tracking-widest font-bold">
                                    {certId}
                                </p>
                            </div>
                            <div className="bg-yellow-900/30 border border-yellow-900/50 text-yellow-500 text-[9px] font-bold tracking-widest uppercase px-2 py-1">
                                REVOKED
                            </div>
                        </div>
                    ...
                    <div className="w-full">
                        <button
                            onClick={onBack}
                            className="w-full py-3 bg-yellow-500 text-black font-bold font-mono text-xs uppercase tracking-widest hover:bg-white transition-colors"
                        >
                            [ NEW_SEARCH ]
                        </button>
                    </div>
